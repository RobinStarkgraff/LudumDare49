...
class IntersectionLevel : Level() {
    ...
    override suspend fun drawImages() {
        ...
        val car1sprite = il.sprite(SpriteLibrary.INTERSECTIONLEVEL_CAR).xy(300.0, 420.0)
        val car2sprite = il.sprite(SpriteLibrary.INTERSECTIONLEVEL_CAR).xy(300.0, 520.0)
