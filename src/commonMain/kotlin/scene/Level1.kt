...
class Level1 : Level() {
    ...
    override suspend fun drawImages() {
        ...
        StateSwapItem(this, lamp, SpriteLibrary.LEVEL1_LAMP, SoundPlayer.SWITCHOFF, SoundPlayer.SWITCHON, interactionDistance = 100.0)
        ...
        StateSwapItem(this, kitchenDoor, SpriteLibrary.DOOR_SWING_LEFT, SoundPlayer.DOORCLOSE, SoundPlayer.DOOROPEN, collider = kitchenDoorCol, interactionDistance = 75.0)
        ...
        StateSwapItem(this, bathroomDoor, SpriteLibrary.DOOR_SWING_LEFT, SoundPlayer.DOORCLOSE, SoundPlayer.DOOROPEN, collider = bathroomDoorCol, interactionDistance = 75.0)
